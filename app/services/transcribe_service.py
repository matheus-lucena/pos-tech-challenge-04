...
class TranscribeService:
    ...
    def __init__(
        ...
        if not self.data_access_role_arn:
            raise ValueError(
                ...
                "Set the AWS_TRANSCRIBE_ROLE_ARN environment variable or pass "
                "data_access_role_arn to the constructor."
            )
    ...
    def _wait_for_completion(self, job_name: str, max_wait_seconds: int) -> str:
        elapsed = 0
